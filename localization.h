  ...
  #define TXT_SEC "segundos"
  #define TXT_MIN "minutos"
  #define TXT_AUTO_DIM "CONFIGURAR TIEMPO DE DIM AUTOMATICO"
  #define TXT_SET_BRIGHT "CONFIGURAR BRILLO"
  #define TXT_BATT_INFO "Informacion de la bateria"
  ...
  #define TXT_MN_AMERICA "Americas / Asia"
  #define TXT_MN_EMEA "EU/Medio Oriente/Africa"
  #define TXT_REGION "Region"
  ...
  #define TXT_SP_RND "Asociacion rapida aleatoria"
  #define TXT_SEL_EXIT2 "\n\nSiguiente: Salir"
  ...
  #define TXT_AJ_TRANSF_NM "Numero de transferencia"
  #define TXT_AJ_TV_COLOR "Balance de color de TV"
  #define TXT_STP_NW_PH "Configurar nuevo telefono"
  #define TXT_SA_ADV "Publicidad de SourApple: "
  #define TXT_SP_ADV "Publicidad de Asociacion Rapida: '%s' - "
  ...
  #define TXT_STK_NXT "Siguiente: Boton lateral"
  #define TXT_STK_SEL "Sel: Boton M5"
  #define TXT_STK_HOME "Inicio: Boton de encendido"
  ...
  #define TXT_WFA_PORTAL "Portal de clonacion"
  #define TXT_WFA_DEAUTH "Ataque de desautorizacion"
  #define TXT_WFA_COMBINED "Desautorizacion+Clonacion"
  #define TXT_BLACK "Negro"
  #define TXT_NAVY "Azul marino"
  #define TXT_DARKGREEN "Verde oscuro"
  #define TXT_DARKCYAN "Cian oscuro"
  #define TXT_MAROON "Marron"
  #define TXT_PURPLE "Purpura"
