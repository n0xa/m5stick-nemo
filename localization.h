  ...
  #define TXT_INST_SEL "Sel : -> or Enter"
  #define TXT_INST_HOME "Home: <- or Esc"
  #define TXT_INST_PRSS_KEY "Press any key to continue"
  ...
  #define TXT_INST_NXT "Prox: Baixo"
  #define TXT_INST_PRV "Ante: Cima"
  #define TXT_INST_SEL "Sel : -> ou Enter"
  #define TXT_INST_HOME "Home: <- ou Esc"
  #define TXT_INST_PRSS_KEY "Pressione qualquer tecla para continuar"
