...
#if defined(LANGUAGE_DE_DE)
  #define TXT_BACK "Zurück"
  #define TXT_CLOCK "Uhr"
  #define TXT_SETTINGS "Einstellungen"
  #define TXT_NEVER "Niemals"
  #define TXT_SEC "Sekunden"
  #define TXT_MIN "Minuten"
  #define TXT_AUTO_DIM "AUTO-DIMMZEIT EINSTELLEN"
  #define TXT_SET_BRIGHT "HELLIGKEIT EINSTELLEN"
  #define TXT_BATT_INFO "Batterie Info"
  #define TXT_BRIGHT "Helligkeit"
  #define TXT_SET_CLOCK "Uhr Einstellen"
  #define TXT_ROTATION "Rotation"
  #define TXT_ABOUT "Über"
  #define TXT_REBOOT "Neustart"
  #define TXT_CLR_SETTINGS "Einstellungen Löschen"
  #define TXT_CLRING_SETTINGS "Werkseinstellungen\nWiederherstellen..."
  #define TXT_RIGHT "Rechts"
  #define TXT_LEFT "Links"
  #define TXT_BATT "Batterie: "
  #define TXT_EXIT "Drücken Sie eine Taste, um zu beenden"
  #define TXT_RG_AMERICAS "Region:\nAmerika / Asien\n"
  #define TXT_RG_EMEA "Region: EMEA"
  #define TXT_SEL_GO_PAUSE "Auswählen: Start/Pause"
  #define TXT_SEL_EXIT "Weiter: Beenden"
  #define TXT_TRIG_TV "TVBG ausgelöst"
  #define TXT_MN_AMERICA "Amerika / Asien"
  #define TXT_MN_EMEA "EU/Nahost/Afrika"
  #define TXT_REGION "Region"
  #define TXT_FK_GP "Fronttaste: Start/Pause"
  #define TXT_SET_HOUR "STUNDE EINSTELLEN"
  #define TXT_SET_MIN "MINUTE EINSTELLEN"
  #define TXT_ADV "Werbung:\n"
  #define TXT_SP_RND "Swift Pair Zufällig"
  #define TXT_SEL_EXIT2 "\n\nWeiter: Beenden"
  #define TXT_BT_SPAM "BT Spam"
  #define TXT_SA_CRASH "SourApple Absturz"
  #define TXT_CMB_BT_SPAM " Kombinierter BT Spam"
  #define TXT_AD_SPAM "Android Spam"
  #define TXT_AJ_TRANSF_NM "Nummer Übertragen"
  #define TXT_AJ_TV_COLOR "TV Farbgleichgewicht"
  ...
  #define TXT_WF_SP "WiFi Spam"
  #define TXT_RND_SSID " - Zufällige SSIDs\n"
  #define TXT_WF_SCAN "WiFi Scannen"
  #define TXT_WF_SPAM_FUN "Spam Lustig"
  #define TXT_WF_SPAM_RR "Spam Rickroll"
  #define TXT_WF_SPAM_RND "Zufälliger Spam"
  #define TXT_WF_RESCAN "[NEU SCANNEN]"
  #define TXT_WF_OPEN "Offen"
  #define TXT_WF_CHANN "Kanal : %d\n"
  #define TXT_WF_CRYPT "Verschlüss.: %s\n"
  #define TXT_SEL_BACK "\nWeiter: Zurück\n"
  #define TXT_HOLD_CLONE "Halten Sie die Auswahl: Klonen\n"
  #define TXT_WF_SCN "WiFi Scan"
  #define TXT_WF_SCNING "Scannen..."
  #define TXT_INST_NXT "Weiter: Pfeil nach unten"
  #define TXT_INST_PRV "Zurück: Pfeil nach oben"
  #define TXT_INST_SEL "Auswählen : Enter oder ->"
  #define TXT_INST_HOME "Start: Esc oder <-"
  #define TXT_INST_PRSS_KEY "Drücken Sie eine Taste"
  #define TXT_STK_NXT "Weiter: Seitentaste"
  #define TXT_STK_SEL "Auswählen : M5-Taste"
  #define TXT_STK_HOME "Start: Power-Taste"
  #define TXT_SDCARD "SD einb./ausb."
  #define TXT_DEAUTH_START "Auswählen>DEAUTH Start\n"
  #define TXT_DEAUTH_STOP "Auswählen>DEAUTH Stopp\n"
  #define TXT_HOLD_ATTACK "Halten Sie die Auswahl: Angriff\n"
  #define TXT_WFA_PORTAL "Klonen Portal"
  #define TXT_WFA_DEAUTH "Deauth-Angriff"
  #define TXT_WFA_COMBINED "Deauth+Klonen"
  #define TXT_BLACK "Schwarz"
  #define TXT_NAVY "Marineblau"
  #define TXT_DARKGREEN "Dunkelgrün"
  #define TXT_DARKCYAN "Dunkelcyan"
  #define TXT_MAROON "Kastanienbraun"
  #define TXT_PURPLE "Lila"
  #define TXT_OLIVE "Oliv"
  ...
  #define TXT_WHITE "Weiß"
  #define TXT_ORANGE "Orange"
  #define TXT_GREENYELLOW "Grüngelb"
  #define TXT_PINK "Rosa"
  #define TXT_COLOR "Benutzerdefinierte Farben"
