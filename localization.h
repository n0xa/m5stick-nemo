  ...
  #define TXT_BACK "Atrás"
  #define TXT_CLOCK "Reloj"
  #define TXT_SETTINGS "Ajustes"
  #define TXT_NEVER "Nunca"
  #define TXT_SEC "segundos"
  #define TXT_MIN	"minutos"
  #define TXT_AUTO_DIM "CONFIGURAR TIEMPO DE DIM AUTOMÁTICO"
  #define TXT_SET_BRIGHT "CONFIGURAR BRILLO"
  #define TXT_BATT_INFO "Información de la batería"
  #define TXT_BRIGHT "Brillo"
  #define TXT_SET_CLOCK "Configurar reloj"
  #define TXT_ROTATION "Rotación"
  #define TXT_ABOUT "Acerca de"
  #define TXT_REBOOT "Reiniciar"
  #define TXT_CLR_SETTINGS "Limpiar ajustes"
  #define TXT_CLRING_SETTINGS "Restaurando ajustes predeterminados\n..."
  #define TXT_RIGHT "Derecha"
  #define TXT_LEFT "Izquierda"
  #define TXT_BATT "Batería: "
  #define TXT_EXIT "Presiona cualquier tecla para salir"
  #define TXT_RG_AMERICAS "Región:\nAméricas / Asia\n"
  #define TXT_RG_EMEA "Región: EMEA"
  #define TXT_SEL_GO_PAUSE "Seleccionar: Avanzar/Pausa"
  #define TXT_SEL_EXIT "Siguiente: Salir"
  #define TXT_TRIG_TV "TVBG activado"
  #define TXT_MN_AMERICA "Américas / Asia"
  #define TXT_MN_EMEA "EU/Medio Oriente/África"
  #define TXT_REGION "Región"
  #define TXT_FK_GP "Tecla frontal: Avanzar/Pausa"
  #define TXT_SET_HOUR "CONFIGURAR HORA"
  #define TXT_SET_MIN "CONFIGURAR MINUTO"
  #define TXT_ADV "Publicidad:\n"  
  #define TXT_SP_RND "Asociación rápida aleatoria"
  #define TXT_SEL_EXIT2 "\n\nSiguiente: Salir"
  #define TXT_BT_SPAM "Spam de Bluetooth"
  #define TXT_SA_CRASH "Crash de SourApple"
  #define TXT_CMB_BT_SPAM "Spam de Bluetooth combinado"
  #define TXT_AD_SPAM "Spam de Android"
  #define TXT_AJ_TRANSF_NM "Número de transferencia"
  #define TXT_AJ_TV_COLOR "Balance de color de TV"
  #define TXT_STP_NW_PH "Configurar nuevo teléfono"
  #define TXT_SA_ADV "Publicidad de SourApple: "
  #define TXT_SP_ADV "Publicidad de Asociación Rápida: '%s' - "
  #define TXT_AD_SPAM_ADV "Publicidad de Spam de Android: "
  #define TXT_AJ_ADV "Publicidad de AppleJuice: "
  #define TXT_WF_SP "Spam de WiFi"
  #define TXT_RND_SSID " - SSIDs aleatorios\n"
  #define TXT_WF_SCAN "Escaneo de WiFi"
  #define TXT_WF_SPAM_FUN "Spam divertido"
  #define TXT_WF_SPAM_RR "Spam de Rickroll"
  #define TXT_WF_SPAM_RND "Spam aleatorio"
  #define TXT_WF_RESCAN "[RESCANEAR]"
  #define TXT_WF_OPEN "Abierto"
  #define TXT_WF_CHANN "Canal: %d\n"
  #define TXT_WF_CRYPT "Cifrado: %s\n"
  #define TXT_SEL_BACK "\nSiguiente: Atrás\n"
  #define TXT_HOLD_CLONE "Mantener Seleccionar: Clonar\n"
  #define TXT_WF_SCN "Escaneo de WiFi"
  #define TXT_WF_SCNING "Escaneando..."
  #define TXT_INST_NXT "Siguiente: Flecha abajo"
  #define TXT_INST_PRV "Anterior: Flecha arriba"
  #define TXT_INST_SEL "Sel: Entrar o ->"
  #define TXT_INST_HOME "Inicio: Esc   o <- "
  #define TXT_INST_PRSS_KEY "         Presiona una tecla"
  #define TXT_STK_NXT "Siguiente: Botón lateral"
  #define TXT_STK_SEL "Sel: Botón M5"
  #define TXT_STK_HOME "Inicio: Botón de encendido"
  #define TXT_SDCARD "Montar/Desmontar SD"
  #define TXT_DEAUTH_START "Seleccionar>Iniciar DEAUTH\n"
  #define TXT_DEAUTH_STOP "Seleccionar>Detener DEAUTH \n"
  #define TXT_HOLD_ATTACK "Mantener Seleccionar: Ataque\n"
  #define TXT_WFA_PORTAL "Portal de clonación"
  #define TXT_WFA_DEAUTH "Ataque de desautorización"
  #define TXT_WFA_COMBINED "Desautorización+Clonación"
  #define TXT_BLACK "Negro"
  #define TXT_NAVY "Azul marino"
  #define TXT_DARKGREEN "Verde oscuro"
  #define TXT_DARKCYAN "Cian oscuro"
  #define TXT_MAROON "Marrón"
  #define TXT_PURPLE "Púrpura"
  #define TXT_OLIVE "Oliva"
  #define TXT_LIGHTGREY "Gris claro"
  #define TXT_DARKGREY "Gris oscuro"
  #define TXT_BLUE "Azul"
  #define TXT_GREEN "Verde"
  #define TXT_CYAN "Cian"
  #define TXT_RED "Rojo"
  #define TXT_MAGENTA "Magenta"
  #define TXT_YELLOW "Amarillo"
  #define TXT_WHITE "Blanco"
  #define TXT_ORANGE "Naranja"
  #define TXT_GREENYELLOW "Amarillo verdoso"
  #define TXT_PINK "Rosa"
  #define TXT_COLOR "Colores personalizados"
  #define TXT_SET_FGCOLOR "COLOR PRINCIPAL"
  #define TXT_SET_BGCOLOR "COLOR DE FONDO"
  #define TXT_THEME "Tema de color"
#endif